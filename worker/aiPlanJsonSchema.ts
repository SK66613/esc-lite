...
const object = (properties: Record<string, JsonSchema>, required: string[] = Object.keys(properties), extra: Record<string, unknown> = {}): JsonSchema => ({ type:'object', properties, required, additionalProperties:false, ...extra });
...
export const AI_PLAN_JSON_SCHEMA: JsonSchema = object({
  id:{type:'string',minLength:1}, userIntent:{type:'string'}, summary:{type:'string'}, explanation:{type:'string'},
