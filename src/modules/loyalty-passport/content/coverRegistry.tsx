...
export function PassportCoverImage({assetId,...props}:{assetId:PassportCoverAssetId}&Omit<ImgHTMLAttributes<HTMLImageElement>,'src'>){const asset=getPassportCoverAsset(assetId);return <img {...props} src={asset.src} data-cover-asset={asset.id}/>;}
