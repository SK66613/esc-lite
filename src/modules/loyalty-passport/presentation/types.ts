...
import type { PassportCoverAssetId } from '../content/coverCatalog';

export interface PassportStamp { index:number; completed:boolean; title:string; iconKey:PassportStampIconKey; cover:{assetId:PassportCoverAssetId}|null }
