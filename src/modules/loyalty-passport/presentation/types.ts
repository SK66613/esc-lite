...
export interface PassportViewModel { name:string; description:string; goal:number; filled:number; remaining:number; progressPercent:number; reward:string; unit:string; stamps:PassportStamp[] }
...
export type PassportConfigInput=Pick<LoyaltyPassportConfig,'name'|'description'|'goal'|'reward'|'balance'|'unit'>;
