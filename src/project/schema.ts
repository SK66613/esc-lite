...
export const GuardInstanceSchema = z.object({ id:z.string(), type:z.string(), enabled:z.boolean(), scope:z.enum(['app','module']).default('app'), moduleId:z.string().optional(), config:z.unknown() });
